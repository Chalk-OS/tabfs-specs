...
+=================+===============+======+============================================+
| TABFS_magic     | 445 / 0x1B7   | 16   | "TABFS-28" (zero-terminated)               |
...
+-----------------+---------------+------+--------------------------------------------+
| private_data    | 461 / 0x1C7   | 32   | private data; can be used for custom use   |
+-----------------+---------------+------+--------------------------------------------+
| bat_LBA         | 493 / 0x1E7   | 6    | the LBA of the first block of the BAT      |
+-----------------+---------------+------+--------------------------------------------+
| max_LBA         | 493 / 0x1ED   | 6    | the max LBA (inclusive) that is allowed to |
|                 |               |      | be used by tabfs                           |
+-----------------+---------------+------+--------------------------------------------+
